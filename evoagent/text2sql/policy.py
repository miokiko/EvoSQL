...
POLICY_CONTRACT_VERSION = "text2sql-policy-v1"
TEXT2SQL_SKILLS = tuple(ROLE_TOOL_PERMISSIONS)
...
class PolicyArtifact:
    ...
    def version(self) -> str:
        return "policy-%s" % hashlib.sha256(_canonical(self.value).encode("utf-8")).hexdigest()[:20]
